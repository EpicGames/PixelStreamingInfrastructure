...
if (config.EnableWebserver) {
	...
	app.get('/', function (req, res) {
		const homepageFile = (typeof config.HomepageFile != 'undefined' && config.HomepageFile != '') ? config.HomepageFile.toString() : defaultConfig.HomepageFile;
